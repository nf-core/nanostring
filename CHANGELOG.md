...
- [#49](https://github.com/nf-core/nanostring/pull/49) - Prevent HK-normalization while loading counts
- [#49](https://github.com/nf-core/nanostring/pull/49) - Use provided normalization method for Non-HK-normalized counts
