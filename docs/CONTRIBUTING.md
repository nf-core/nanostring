...
Hi there!
Thanks for taking an interest in improving nf-core/nanostring.

This page describes the recommended nf-core way to contribute to both nf-core/nanostring and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/nanostring.

> [!NOTE]
> If you need help using or modifying nf-core/nanostring, ask on the nf-core Slack [#nanostring](https://nfcore.slack.com/channels/nanostring) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/nanostring/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/nanostring repository](https://github.com/nf-core/nanostring) to your GitHub account.
...
For further information and help, see the [nf-core/nanostring documentation](https://nf-co.re/nanostring/usage) or ask on the nf-core [#nanostring](https://nfcore.slack.com/channels/nanostring) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/nanostring without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/nanostring/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/nanostring code and processing logic more understandable for new contributors and to ensure quality.
