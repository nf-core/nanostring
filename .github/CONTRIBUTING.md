...
We try to manage the required tasks for nf-core/nanostring using GitHub issues, you probably came to this page when creating one.
...
If you'd like to write some code for nf-core/nanostring, the standard workflow is as follows:

1. Check that there isn't already an issue about your idea in the [nf-core/nanostring issues](https://github.com/nf-core/nanostring/issues) to avoid duplicating work
