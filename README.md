...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?logo=Amazon%20AWS)](https://nf-co.re/nanostring/results)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23nanostring-4A154B?logo=slack)](https://nfcore.slack.com/channels/nanostring)
...
**nf-core/nanostring** is a bioinformatics best-practice analysis pipeline for A Nanostring nCounter analysis workflow.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```console
   nextflow run nf-core/nanostring -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```console
   nextflow run nf-core/nanostring --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```

## Documentation

The nf-core/nanostring pipeline comes with documentation about the pipeline [usage](https://nf-co.re/nanostring/usage), [parameters](https://nf-co.re/nanostring/parameters) and [output](https://nf-co.re/nanostring/output).
